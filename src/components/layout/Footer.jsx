      ...
      <footer className="bg-primary-card flex flex-col">
            ...
            <ul>
              <li className="no-underline">
                <a
                  ...
                  target="_blank"
                >
                  7 H.Aliyev, Baku, Azerbaijan AZ1010 Lorem ipsum, dolor sit
                  amet consectetur adipisicing elit. Nulla ut possimus
                  praesentium sint saepe. Nihil distinctio error, aliquid qui
                  nobis itaque sapiente ea quia praesentium dolorem ut
                  cupiditate consequatur suscipit.
                </a>
              </li>
        ...
        <div className="px-16 mt-4 flex w-full justify-between flex-row  max-sm:flex-col">
          ...
          <div className="flex items-center">
            <p className="flex   items-center max-sm:pt-4"> Site created by: </p>
            <span className="w-[180px] ml-2 mb-2 bg-white">
