  ...
  return (
    <nav className="flex w-full justify-center items-center px-6 py-3 bg-primary-card lg:bg-primary-bg">
      <div className="w-full max-w-[1200px] flex items-center justify-evenly">
        ...
        >
          <NavLink to={'/'} className="navlink lg:p-0" onClick={onLinkClick}> {textStorage.mainNews} </NavLink>
          ...
          <NavLink to={'/rubrics'} className="navlink lg:p-0"> {textStorage.rubrics} </NavLink>
        </div >
