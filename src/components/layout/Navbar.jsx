...
export default function Navbar({ className, animation }) {
  return (
    <div className={`text-white mt-3 lg:flex items-center justify-evenly fixed lg:static left-0 bg-primary-card w-full p-3 lg:bg-inherit ${className} ${animation}`}>
